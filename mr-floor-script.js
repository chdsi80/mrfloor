...
$(window).on("load", function() {
  ...
  if(is_floor_finder !== -1 && is_category_page !== -1) {
    ...
    setTimeout(() => {
      ...
      $('.filter_results-text .text-color-green').on('DOMSubtreeModified', function(){
...
$(".product-container .w-pagination-previous.load-more-button, .product-container .w-pagination-next.load-more-button").click(function() {
