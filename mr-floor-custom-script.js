...
$(document).ready(function() {
  ...
  $(".shop-slider").slick({
    ...
    slidesToScroll: 1,
    prevArrow: "<img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/610249ab428d1346a2f97bd4_arrow-prev.png' alt='prev' class='arrow-prev' />",
    nextArrow: "<div class='get-direction w-inline-block'><div class='pos-relative'>Next Location</div><img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/611ce8bf5170c220f4db04c4_back%201.png' alt='' class='get-direction-icon'></a>",
    responsive: [
      {
        breakpoint: 600,
        settings: {
  ...
  if(window.innerWidth < 768) {
    $(".speciality-slider").slick({
      ...
      slidesToScroll: 1,
      prevArrow: "<img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/610249ab428d1346a2f97bd4_arrow-prev.png' alt='prev' class='arrow-prev' />",
      nextArrow: "<div class='get-direction w-inline-block'><div class='pos-relative'>Next</div><img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/611ce8bf5170c220f4db04c4_back%201.png' alt='' class='get-direction-icon'></a>",
    ...
    $(".delivery-process-wrapper .grid-2").slick({
      ...
      slidesToScroll: 1,
      prevArrow: "<img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/610249ab428d1346a2f97bd4_arrow-prev.png' alt='prev' class='arrow-prev' />",
      nextArrow: "<div class='get-direction w-inline-block'><div class='pos-relative'>Next Step</div><img src='https://uploads-ssl.webflow.com/60fe23d9684b463c30c4d711/611ce8bf5170c220f4db04c4_back%201.png' alt='' class='get-direction-icon'></a>",
      responsive: [
        {
          breakpoint: 600,
          settings: {
...
function addItemToWishlist(_product_image, _product_name, _product_url) {
  ...
  if(_wishlist_arr.find(o => o.product === _product_name) !== undefined) {
    toastr.info('Product is already in your touch list', 'Hey!', {timeOut: 2000});
  } else {
